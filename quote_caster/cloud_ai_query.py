...
def query_openai(prompt, model="gpt-4"):
    api_key = "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"
    if not api_key:
    ...
    response = client.chat.completions.create(
        model=model,
        messages=[
            {"role": "system", "content": "You are an expert in natural language understanding."},
...
def main():
    parser = argparse.ArgumentParser(description="Assign speakers to dialogue using OpenAI ChatGPT.")
